...
const requirementCatalog: readonly RequirementFactoryItem[] = [
  ...
  },
  {
    ...
    description: "Selecione o agente de contratação e seu ato de designação no cadastro de responsáveis.",
    obrigatorio: true,
    source: "CATALOG",
    completionStrategy: "CATALOG_SELECTION",
    editor: "INSTITUTIONAL_SELECTOR",
    completionHint: "Concluído ao selecionar um agente cadastrado. Decretos anexados anteriormente são preservados.",
  },
  {
