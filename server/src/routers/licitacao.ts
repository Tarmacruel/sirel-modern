      ...
      items: items.map((item) => ({
        ...
        proximaEtapa:
          [
            ...
            { label: "Recebimento de propostas", value: item.dataRecebimentoPropostasFim },
            ...
            .sort((a, b) => new Date(String(a.value)).getTime() - new Date(String(b.value)).getTime())[0]?.label ?? null,
        proximaData:
          [
